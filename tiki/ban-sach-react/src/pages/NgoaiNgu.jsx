...
class NgoaiNgu extends React.Component {
    state = {
        data: [],
        fullName: '',
        role: ''
    ...
    componentDidMount() {
        fetch(`http://localhost:3001/products/findNgoaiNgu`, {
            method: 'GET',
            credentials: 'include',
            headers: {
                    ...
                    {this.state.data.map((item) => {
                        return (
                            <div class="box">
                                ...
                                <div align="center">
                                    {this.state.role ==='users'? <input class="button" type="button" value="Mua hàng" onClick={(event) => {
                                        if (this.state.role) {
                                    ...
                                    }} />:<input class="button" type="button" value="Xóa" onClick={(event) => {
                                        if (this.state.role) {
                                            fetch(`http://localhost:3001/products/delete/${item.title}`, {
                                                method: 'PUT',
                                                headers: {
                                                    'Content-Type': 'application/json',
                                                },
