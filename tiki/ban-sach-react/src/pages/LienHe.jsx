                ...
                <article>
                    <form>
                        <div className="form-group">
                            <div>Họ Tên</div>
                            <textarea className="form-control" id="exampleFormControlTextarea1" rows="1" placeholder="Mời bạn nhập tên" ></textarea>
                        </div>
                        <div className="form-group">
                            <div>Mời bạn nhập email</div>
                            <textarea className="form-control" id="exampleFormControlTextarea1" rows="1" placeholder="Mời bạn nhập email" ></textarea>
                        </div>
                        <div className="form-group">
                            <div>Mời bạn nhập tiêu đề</div>
                            <textarea className="form-control" id="exampleFormControlTextarea1" rows="1" placeholder="Mời bạn nhập tiêu đề" ></textarea>
                        </div>
                        <div className="form-group">
                            <div>Nội Dung</div>
                            <textarea className="form-control" id="exampleFormControlTextarea1" rows="4" placeholder="Mời bạn nhập nội dung" ></textarea>
                        </div>
                        <div className="form-group">
                            <input type="submit" className="btn btn-primary" value="Gửi thông tin"></input>
                        </div>
                    </form>
